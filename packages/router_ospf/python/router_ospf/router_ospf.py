...
class ServiceCallbacks(Service):
    ...
    def cb_create(self, tctx, root, service, proplist):
        ...
        for net in service.network: 
            ...
            net_vars.add("device", service.device)
            net_vars.add("process_id", service.process_id)  
            net_vars.add("network_address", net.network_address)
            net_vars.add("wildcard_mask", net.wildcard_mask)
            net_vars.add("area", net.area)
